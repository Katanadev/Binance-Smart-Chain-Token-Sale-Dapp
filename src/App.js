    ...
    <div className="App">
      ...
      >
        {web3 ? (
            ...
            error.startsWith("Wrong network") ? (
              ...
              !completed ? (
                <div className="rounded bg-dark p-5 opacity">
                  <div>
                    TOTAL RAISED: <span className="pink-text">{web3.utils.fromWei(raised.toString(), "ether")}</span> BNB
                    <br />
                    ...
                    <br />
                    MY CONTRIBUTION: <span className="pink-text">{web3.utils.fromWei(mine.toString(), "ether")}</span> BNB
                  ...
                  {!onlyWhitelisted || (onlyWhitelisted && isWhitelisted) ? (
                    <>
                      ...
                      >
                        ...
                        <p className="p-0 m-0">
                          Symbol: <span className="pink-text">CANYON</span>
                        </p>
                        <p className="p-0 m-0">
                    ...
                    <p>YOU ARE NOT WHITELISTED, WAIT FOR PUBLIC LISTING</p>
                  )}
                </div>
              ) : (
                <p>PRIVATE SALE HAS ALREADY CLOSED</p>
              )
            ) : (
              <p>PRIVATE SALE HAS NOT STARTED YET</p>
            )
          ) : (
            <>
              <p>{"USE METAMASK OR TRUSTWALLET"}</p>
          ...
          <>
            <p>INSTALL METAMASK / TRUSTWALLET</p>
            <p>OR</p>
